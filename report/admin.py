...
class WeeklyReportAdmin(admin.ModelAdmin):
    list_display=('week_number','engagement','action','follow_up','course_offering','student','get_sessions_is_present','no_of_pages_viewed_on_canvas','login_in_on_canvas','performance')
