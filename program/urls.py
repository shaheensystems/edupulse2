...
from .views import CourseListView, CourseOfferingListView,ProgramListView,ProgramDetailView,ProgramOfferingListView,ProgramOfferingDetailView,CourseOfferingDetailView
